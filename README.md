...
For a product plugin that integrates an external service or device, read `product-plugin-design-guide.md` from that snapshot before choosing plugin boundaries, Unit types, Catalog selectors, or state synchronization.
